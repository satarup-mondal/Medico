      ...
      <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
         ...
         <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'> 
            {relDoc.slice(0,5).map((item , index)=> (
                <div onClick={()=> {navigate(`/appointment/${item._id}`); scrollTo(0,0)}} className='flex flex-col items-center text-center border border-blue-200 bg-white p-4 rounded-xl shadow-sm transform transition-all duration-300 hover:shadow-lg hover:-translate-y-2' key={index}>
